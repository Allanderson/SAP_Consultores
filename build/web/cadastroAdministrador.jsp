                ...
                <h1>Cadastro do Administrador</h1>
                    <fieldset id="dadospessoais">
                        ...
                        <table id="dadospessoais">
                            <tr>
                                <p><td><label for="cnomecadastro">Nome:</label></td><td><input type="text" class="inputdadospesoais" name="nome" id="cnomecadastro" size="30" maxlength="50" placeholder="Digite seu nome"  required = "required"/></td></p>
                            </tr>
                            <tr>
                                <p><td><label for="csobrenome">Sobrenome:</label></td><td><input type="text" class="inputdadospesoais" name="sobrenome" id="csobrenome" size="30" maxlength="50" placeholder="Digite seu sobre nome" required = "required"/></td></p>
                            </tr>

                            <tr>
                                <p><td><label for="cemail">Email:</label></td><td><input type="email" class="inputdadospesoais" name="email" id="cemail" size="30" maxlength="50" placeholder="Ex: consultores@gmail.com" required = "required"/></td></p>
                            </tr>
                            <tr> 
                                <p><td><label for="csenha">Senha:</label></td><td><input type="password" name="senha" class="inputdadospesoais" id="csenha" size="30" maxlength="15" placeholder="Até 15 dígitos" required = "required"/></td></p>
                            </tr>
                            <tr>
                                <p><td><label for="cconfirmasenha">Confirmar Senha:</label></td><td><input type="password" name="confirmarsenha" id="cconfirmasenha" class="inputdadospesoais" size="30" maxlength="15" placeholder="Repita a senha" required = "required"/></td></p>
                            </tr> 
                        </table>
